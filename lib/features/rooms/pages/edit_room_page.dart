...
class _EditRoomPageState extends State<EditRoomPage> {
  ...
  String _getRoomTypeValue(RoomType roomType) {
    switch (roomType) {
      case RoomType.shreeHariPlus:
        return 'SHREEHARIPLUS';
      case RoomType.shreeHari:
        return 'SHREEHARI';
      case RoomType.sarjuPlus:
        return 'SARJUPLUS';
      case RoomType.sarju:
        return 'SARJU';
      case RoomType.neelkanthPlus:
        return 'NEELKANTHPLUS';
      case RoomType.neelkanth:
        return 'NEELKANTH';
    }
  }

  String _getBedTypeValue(BedType bedType) {
    switch (bedType) {
      case BedType.single:
        return 'SINGLE';
      case BedType.double:
        return 'DOUBLE';
      case BedType.extraBed:
        return 'EXTRA_BED';
    }
  }
  ...
  Future<void> _loadRoomDetails() async {
    try {
      ...
      setState(() {
        ...
        _type = _getRoomTypeValue(room.type);
        _beds = room.beds
            .map((bed) => {
                  'type': _getBedTypeValue(bed.type),
                  'quantity': bed.quantity,
                })
            .toList();
        _hasGeyser = room.hasGeyser;
        _hasAc = room.hasAc;
        _hasSofaSet = room.hasSofaSet;
        _sofaSetQuantityController.text = room.sofaSetQuantity?.toString() ?? '';
        _extraAmenitiesController.text = room.extraAmenities ?? '';
        _isVisible = room.isVisible;
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Padding(
                        ...
                        child: Text(_isLoading ? 'Updating...' : 'Update Room'),
                      ),
